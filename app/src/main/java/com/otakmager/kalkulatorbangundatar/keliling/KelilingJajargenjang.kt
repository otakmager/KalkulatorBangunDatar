...
import com.otakmager.kalkulatorbangundatar.databinding.ActivityKelilingJajargenjangBinding

class KelilingJajargenjang : AppCompatActivity() {
    private lateinit var binding: ActivityKelilingJajargenjangBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKelilingJajargenjangBinding.inflate(layoutInflater)
