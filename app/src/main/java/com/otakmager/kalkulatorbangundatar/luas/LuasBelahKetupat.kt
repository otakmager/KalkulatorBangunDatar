...
import com.otakmager.kalkulatorbangundatar.databinding.ActivityLuasBelahKetupatBinding

class LuasBelahKetupat : AppCompatActivity() {
    private lateinit var binding: ActivityLuasBelahKetupatBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLuasBelahKetupatBinding.inflate(layoutInflater)
